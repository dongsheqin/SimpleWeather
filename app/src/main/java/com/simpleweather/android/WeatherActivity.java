...
import com.simpleweather.android.util.JsonUtil;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weatherString != null) {
            ...
            if(getIntent().getStringExtra("weather_id") == null){
                ...
                if (getIntent().getStringExtra("weather_id") != mWeatherId) {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=5325a23b65de46c4b89117bed1ab5c1b";
